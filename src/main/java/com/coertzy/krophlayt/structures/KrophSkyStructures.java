...
public class KrophSkyStructures extends StructureFeature<JigsawConfiguration> {
    ...
    public KrophSkyStructures() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, KrophSkyStructures::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        ...
        if (!KrophSkyStructures.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            KrophMain.LOGGER.log(Level.DEBUG, "Rundown House at {}", blockpos);
        }
